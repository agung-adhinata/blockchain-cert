    ...
    if (typeof window.ethereum !== "undefined") {
      try {
        (async() => {
          ...
          const contract = new ethers.Contract(CertificationAddress, CertificationABI.abi, provider);
          const certificates = contract.getSignedCertificatesByOwner(signer.getAddress());
